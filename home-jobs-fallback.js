(function(){
  ...
  async function run(){
    ...
    try{
      ...
      if(error){console.error('YOCEWOR home fallback:',error);return;}
      render(data||[]);
    }catch(e){console.error('YOCEWOR home fallback:',e);}
  }
  document.addEventListener('DOMContentLoaded',function(){setTimeout(run,1200);setTimeout(run,3000);});
})();
